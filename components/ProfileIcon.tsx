...
const ProfileIcon = ({user, rankStyle, pb, inbox, requests}: {user?: User, rankStyle: string, pb: string, inbox: number, requests: number}) => {
  ...
  return (
    <div className='relative flex flex-col items-center'>
        ...
        <div onMouseLeave={() => setShow(false)} style={{visibility: show ? 'visible' : 'hidden'}} className='text-white min-w-44 z-150 w-full py-6 rounded-2xl bg-[rgb(28,38,56)] absolute top-12 shadow-lg shadow-black'>
