...
//  const handleLogin = async (e: FormEvent, prov: Provider | string) => {
//      e.preventDefault();
...
//                 <Button onClick={(e) => handleLogin(e, 'github')} variant="outline" className="w-full">
...
//                   Login with Github
//                 </Button>
//                 <Button onClick={(e) => handleLogin(e, 'google')} variant="outline" className="w-full">
